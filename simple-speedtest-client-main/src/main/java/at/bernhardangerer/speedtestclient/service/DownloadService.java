...
public final class DownloadService extends AbstractTransferService {
    ...
    public static TransferTestResult testDownload(final String serverUrl, final DownloadSetting settings, final Callback callback)
    ...
    static List<String> generateUrls(final String serverUrl, final int threadsPerUrl) {
